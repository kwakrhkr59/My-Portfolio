          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200/50 dark:border-slate-700/50 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="group">
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 dark:bg-slate-700/50 group-hover:bg-green-50 dark:group-hover:bg-green-900/20 transition-all duration-300">
                    <div className="flex-shrink-0 w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
